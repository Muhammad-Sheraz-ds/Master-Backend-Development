...
## Exercises
1. Install PostgreSQL on your local machine using the official installer for your operating system.
2. Install PostgreSQL using Docker.
3. Configure a Docker volume to persist PostgreSQL data.
4. Change the postgres user's password.
5. Configure pg_hba.conf to use scram-sha-256 authentication.
